...
func Test(t *testing.T) {
	Convey("Decompose", t, func() {
		...
		So(labelled, ShouldEqual, "One var {Key1}")
		...
		So(labelled, ShouldEqual, "Two vars {IntVarName2} {StrVarName1}")
		...
		So(labelled, ShouldEqual, "Same vars %% {VarName1} {VarName1}")
		So(len(variables), ShouldEqual, 1)
		...
		So(labelled, ShouldEqual, "Two vars {VarName1} {Moar2}")
		So(len(variables), ShouldEqual, 2)
		...
		So(labelled, ShouldEqual, "One var {VarName1}")
		So(len(variables), ShouldEqual, 1)
		...
		So(labelled, ShouldEqual, "One var {VarName1} {Float2} {Var3}")
		...
		So(labelled, ShouldEqual, "One var {Var1} {Var1} {Num2}")
		So(len(variables), ShouldEqual, 2)

		replaced, labelled, variables, err = Decompose("One var %d %d", ".VarName", ".VarName")
		So(err, ShouldEqual, nil)
		So(replaced, ShouldEqual, "One var %[1]d %[2]d")
		So(labelled, ShouldEqual, "One var {VarName1} {VarName2}")
		So(len(variables), ShouldEqual, 2)
		...
		So(labelled, ShouldEqual, "One var {V1011}")
		So(len(variables), ShouldEqual, 1)
